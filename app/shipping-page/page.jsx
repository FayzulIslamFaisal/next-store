      ...
      <div className="container">
        <div className="row gy-5 gy-lg-0 gx-0 gx-lg-5">
          <div className="col-lg-8">
            <div className="row nhn-shipping-deliver-detail-area">
              <div className="col-md-12">
                <div
                  className="nhn-shipping-deliver-detail rounded-2 flex-column d-flex gap-2"
                >
                  <div className="nhn-shipping-deliver-title">
                    <p>Deliver to: Jonas Schmedtmann</p>
                  </div>
                  <div className="nhn-shipping-deliver-detail-info">
                    <p>
                      <span className="text-capitalize">Mobile</span> <small>1618329725</small> | House 272 3
                      Flat H2 West Agargaon, Kallyanpur, Dhaka- North, Dhaka,
                      kallyanpur bus stand <button
                        type="button"
                  ...
                  <div className="modal fade change-nhn-shipping-address-modal"
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                      <div className="modal-content">
                              ...
                              <div className="shipping-delivery-address-radiobox ">
                                ...
                                <label htmlFor="radio1">
                                  ...
                                  <div className="shipping-delivery-radio-info d-flex flex-column gap-2">
                                    ...
                                    <span>01789654236</span>
                                    <p>Dhaka, Dhaka - North, Kallyanpur, House 272 3 Flat H2 West Agargaon, kallyanpur bus stand</p>
                        ...
                        <div className="modal-footer justify-content-between">
                          ...
                          <button type="button" className="btn add-to-cart-link">
                            Confirm
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="nhn-shipping-deliver-pic-point rounded-3">
                    <p>
                      Collect your parcel from the nearest Nagadhat Pick-up Point
                      with a reduced shipping fee 20 suggested collection
                      point(s) nearby Check <button data-bs-toggle="modal" data-bs-target="#shipping-pick-point-modal">Pick-up Points</button>
                    </p>
                  </div>
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-body">
                          <div className="row g-2">
                            <div className="col-md-6 col-sm-12">
                              <div className="shipping-delivery-address-radiobox ">
                                <input id="radio3" type="radio" name="license-radios" className="shipping-delivery-address-radio"/>
                                <label htmlFor="radio3">
                                  <span className="license_type_circle"> </span>
                                  <div className="shipping-delivery-radio-info d-flex flex-column gap-2">
                                    <div className="d-flex justify-content-between flex-column">
                                      <p>Nagadhat E-courier kallyanpur Collection Point-</p>
                                      <p>09:30:00-17:00:00</p>
                                    </div>
                                    <p>Nagadhat E-courier kallyanpur Collection Point, 144, <br/> Muktobangla Shopping Complex, kallyanpur, Dhaka, kallyanpur,Dhaka - North, Dhaka </p>
                                  </div>
                                </label>
                              </div>
                            </div>
                            <div className="col-md-6 col-sm-12">
                              <div className="shipping-delivery-address-radiobox ">
                                <input id="radio4" type="radio" name="license-radios" className="shipping-delivery-address-radio"/>
                            ...
                            <div className="col-md-6 col-sm-12">
                              <div className="shipping-delivery-address-radiobox ">
                                <input id="radio5" type="radio" name="license-radios" className="shipping-delivery-address-radio"/>
                  ...
                  <div className="nhn-shipping-deliver-edit-mail">
                    <p>
                      Email to jonasschmedtmann@gmail.com <button
                        type="button"
                        data-bs-toggle="modal"
            ...
            <div className="row new-nh-shipping-row">
              <div className="col-12">
                <div
                  className="new-nh-shipping-area d-flex justify-content-center rounded-2"
                >
                  <button
                    type="button"
                    className="btn d-flex align-items-center justify-content-center gap-2"
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6 pb-3">
                            <label htmlFor="mobile" className="form-label"
                              >Mobile Number
                              <span className="text-danger fw-bold">*</span></label
                            >
                            <input
                              type="text"
                              name="mobile"
            ...
            <div className="row new-nh-shipping-product-row">
              <div className="col-12">
                <div
                  className="product-cart-details-continer table-responsive rounded-2"
                >
                  <table className="table align-middle">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div
                            className="d-flex flex-column gap-1 align-items-center justify-content-between new-nh-product-price"
                          >
                            <p>৳ 500</p>
                            <del className="rounded-1">৳ 320</del>
                          </div>
                        </td>
                      </tr>
                      <tr>
              ...
              <div className="col-12">
                <div className="order-info-area">
                  ...
                  <div className="d-flex gap-3 flex-column border-bottom pb-3">
                    <div
                      className="d-flex gap-3 justify-content-between shopping-price-area custom-shopping-price"
                    >
                      ...
                      <div
                        className="shopping-price-culmn gap-1 flex-shrink-0 d-flex flex-column align-items-center justify-content-center"
                      >
                        <strong>৳ 35,000</strong>
                        <del className="rounded-1">৳ 36,000</del>
                      </div>
                    </div>
                    <div
                      className="d-flex gap-3 justify-content-between shopping-price-area custom-shopping-price"
                    >
                      ...
                      >
                        <strong>৳ 2800</strong>
                        <del className="rounded-1">৳ 3000</del>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="d-flex gap-2 flex-column border-bottom pb-3">
                    <div
                      className="d-flex gap-3 justify-content-between align-items-center shopping-price-area custom-shopping-price"
                    >
                      <strong>Total</strong>

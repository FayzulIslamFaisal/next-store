        ...
        <>
            ...
            <div className="pb-4">
                <p className="fs-6 lh-lg">
                    ...
                    উভয় পক্ষ ০২ মাসের লিখিত পত্রের মাধ্যমে চুক্তিটি বাতিল করতে
                    পারবেন। মেয়াদপূর্তির আগে কোন পক্ষ যদি চুক্তি বাতিল করতে
                    চায়, এক্ষেত্রে ১ম পক্ষের ইনভয়েজে পরিশোধিত টাকা থেকে ২২%
                    সার্ভিস চার্জ কর্তন পূর্বক ২য় পক্ষ ইতোপূর্বে যে পরিমান অর্থ
                    পরিশোধ করেছেন, তা কর্তন করে বাকী পণ্য অথবা সমমূল্য টাকা ফেরত
            ...
            <div className="pb-4">
                <p className="fs-6 lh-lg">
                    ...
                    আমি এই চুক্তির মাধ্যমে অর্জিত বা প্রাপ্য অর্থ আমার মৃত্যুর
                    পর নিম্নে বর্ণিত ব্যক্তিকে প্রদানের জন্য মনোনীত করলাম। আমি
                ...
                <h5 className="fs-6 fw-semibold ">
                    চুক্তির সকল শর্ত বুঝে, সুস্থ্য মস্তিষ্কে ও বিনা প্ররোচনায়
                    স্বাক্ষীগণের উপস্থিতিতে স্বাক্ষর করিলাম,
                </h5>
            </div>
        </>
    );
...
export default SaleOnNagadhatBottom;

                    ...
                    <div className="row shipping-top-area">
                        <div className="col-12">
                            <div className="shipping-top-holder flex-column flex-sm-row align-items-sm-center gap-2 ">
                                <h1 className="shipping-section-title">Shipping Details</h1>
                    ...
                    <div className="shaipping-from-area">
                        <from className="row ">
                            <div className="col-md-6 pb-3">
                                <label htmlFor="fast-name" className="form-label">First Name</label>
                                <input type="text" name="fast-name" className="form-control" id="fast-name"/>
                            </div>
                            <div className="col-md-6 pb-3">
                                <label htmlFor="lest-name" className="form-label">Last Name</label>
                                <input type="text" className="form-control" name="lest-name" id="lest-name"/>
                            </div>
                            <div className="col-md-6 pb-3">
                                <label htmlFor="mobile" className="form-label">Mobile Number <span className="text-danger fw-bold">*</span></label>
                            ...
                            <div className="col-md-12 pb-3">
                                ...
                                <textarea name="address" id="address" className="form-control textarea-resize" rows="2"></textarea>
                            </div>                        
                            <div className="col-md-12 pb-3">
                                <label htmlFor="note" className="form-label">Note</label>
                                <textarea className="form-control textarea-resize" name="note" id="note" rows="2"></textarea>
                            </div>
                            <div className="col-md-12">
                                <div className="form-check">
                                    <input className="form-check-input shipping-checkbox" type="checkbox" id="address-book"/>
                                    <label className="form-check-label" htmlFor="address-book">
                                        Add to address book
                                    </label>
                                </div>
                            </div>
                        ...
                        <div className="col-12">
                            <div className="order-info-area">
                                ...
                                <div className="place-order-btn">
                                    <button className="add-to-cart-link border border-0 w-100">PLACE ORDER</button>
                                </div>
                                <p>

          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item customer-dashboard-nav-item">
              ...
              >
                ...
                <FaAngleRight
                  className={`dropdown ${
                    activeDropdown === "privilegeCard" ? "rotate" : ""
                  }`}
                />
              </p>
              <ul
            ...
            <li className="nav-item customer-dashboard-nav-item">
              ...
              >
                ...
                <FaAngleRight
                  className={`dropdown ${
                    activeDropdown === "affiliate" ? "rotate" : ""
                  }`}
                />
              </p>
              <ul
            ...
            <li className="nav-item customer-dashboard-nav-item">
              <Link className="nav-link customer-dashboard-nav-link" href="#">
            ...
            <li className="nav-item customer-dashboard-nav-item">
              ...
              >
                ...
                <FaAngleRight
                  className={`dropdown ${
                    activeDropdown === "settings" ? "rotate" : ""
                  }`}
                />
              </p>
              <ul

                                    ...
                                    <div className="product-long-discription-tab">
                                        <nav>
                                            <div className="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                                ...
                                                <button className="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab"  >Q & A</button>
                                            </div>
                                        </nav>
                                        <div className="tab-content p-3 " id="nav-tabContent">
                                            <div className="tab-pane fade active show" id="nav-specification" role="tabpanel" aria-labelledby="nav-specification-tab">
